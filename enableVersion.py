...
def set_enableVersion(cookie,x_csrf_token,x_token,not_enableVersion_list):
    ...
    for version in version_list:
        if version in not_enableVersion_list:
            set_url = "https://bugly.qq.com/v2/apps/81452cad5e/platformId/2/userId/9BC53E3B6045DD9F75394B209D29119B/isShow/true/enableVersion?version="+str(version)
